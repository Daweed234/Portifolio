      ...
      <nav className="px-5 py-5 dark:bg-[#0D2538]">
        <div className="flex justify-between items-center md:container mx-auto">
          <div className="flex justify-center items-center flex-grow">
            ...
            <Link to="/about" className="ml-8 text-sm md:text-base md:ml-12">
              About
            </Link>
            <Link to="/projects" className="ml-8 text-sm md:text-base md:ml-12">
              Projects
            </Link>
            <Link to="/contact" className="ml-8 text-sm md:text-base md:ml-12">
              Contact
            </Link>
          </div>
          <div>
